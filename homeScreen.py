...
class Page3(Page):
    def __init__(self, *args, **kwargs):
        ...
        sleep_state = IntVar()
        sleep = Checkbutton(self, text="Sleep", variable=sleep_state, font=("Comic Sans MS", 20), bg="black",
                            fg='white', highlightbackground="SpringGreen2")
        sleep.place(relx=.28, rely=.2, anchor="c")

        exercise_state = IntVar()
        exercise = Checkbutton(self, text="Exercise", variable=exercise_state, font=("Comic Sans MS", 20), bg="black",
                               fg='white', highlightbackground="SpringGreen2")
        exercise.place(relx=.28, rely=.3, anchor="c")

        caffeine_state = IntVar()
        caffeine = Checkbutton(self, text="Caffeine", variable=caffeine_state, font=("Comic Sans MS", 20), bg="black",
                               fg='white', highlightbackground="SpringGreen2")
        caffeine.place(relx=.28, rely=.4, anchor="c")

        mood_state = IntVar()
        mood = Checkbutton(self, text="Mood", variable=mood_state, font=("Comic Sans MS", 20), bg="black", fg='white',
                           highlightbackground="SpringGreen2")
        mood.place(relx=.28, rely=.5, anchor="c")

        confidence_state = IntVar()
        confidence = Checkbutton(self, text="Confidence", variable=confidence_state, font=("Comic Sans MS", 20),
                                 bg="black", fg='white', highlightbackground="SpringGreen2")
        confidence.place(relx=.48, rely=.2, anchor="c")

        screenTime_state = IntVar()
        screenTime = Checkbutton(self, text="Screen Time", variable=screenTime_state, font=("Comic Sans MS", 20),
                                 bg="black", fg='white', highlightbackground="SpringGreen2")
        screenTime.place(relx=.48, rely=.3, anchor="c")

        socializing_state = IntVar()
        socializing = Checkbutton(self, text="Socializing", variable=socializing_state, font=("Comic Sans MS", 20),
                                  bg="black", fg='white', highlightbackground="SpringGreen2")
        socializing.place(relx=.48, rely=.4, anchor="c")

        productivity_state = IntVar()
        productivity = Checkbutton(self, text="Productivity", variable=productivity_state, font=("Comic Sans MS", 20),
                                   bg="black", fg='white', highlightbackground="SpringGreen2")
        productivity.place(relx=.48, rely=.5, anchor="c")

        hygiene_state = IntVar()
        hygiene = Checkbutton(self, text="Hygiene", variable=hygiene_state, font=("Comic Sans MS", 20), bg="black",
                              fg='white', highlightbackground="SpringGreen2")
        hygiene.place(relx=.68, rely=.2, anchor="c")

        self.categories = [sleep_state.get(), exercise_state.get(), caffeine_state.get(), mood_state.get(),
                      confidence_state.get(), screenTime_state.get(), socializing_state.get(), productivity_state.get(),
                      hygiene_state.get()]
